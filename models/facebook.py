...
class FacebookPostResponse(FacebookPostBase):
    ...
    image_path:      Optional[str] = Field(None, description="Path to the generated image for the post")
...
class FacebookTokenRecord(BaseModel):
    ...
    user_id:         Optional[str] = Field(None, description="Facebook User ID associated with the token")
    page_id:         Optional[str] = Field(None, description="Facebook Page ID linked to this agent")
    page_access_token: Optional[str] = Field(None, description="Encrypted access token for the linked Facebook Page")
    page_name:       Optional[str] = Field(None, description="Name of the linked Facebook Page")
